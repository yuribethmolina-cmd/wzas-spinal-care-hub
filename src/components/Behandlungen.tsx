...
export function Behandlungen() {
  const t = useT({
    ...
    en: {
      ...
      h2a: "Treatment first, ",
      h2b: "surgery only when necessary",
      lead:
      ...
      leftKicker: "Non-surgical",
      leftH: "Conservative treatment",
      leftIntro: "Most back conditions do not require surgery. Conservative care is the first and often the only step.",
      leftRows: [
        ...
        { title: "Medication", text: "Tablets or infusions can help break the cycle of pain, guarded movement and muscle tension." },
      ...
      midH: "Between conservative care and surgery",
      ...
      midRows: [
        ...
        { title: "Spinal cord stimulation (SCS)", text: "Mild electrical impulses modify pain signals before they reach the brain." },
      ...
      rightH: "When surgery is necessary",
      rightIntro: "Microsurgical and tissue-sparing, with a clear medical indication. Surgery is never our default approach.",
      rightRows: [
