...
export const doctors: Doctor[] = [
  ...
  },
  {
    ...
    role: "Neurochirurgin",
    specialties: ["Neurochirurgie", "Wirbelsäulenchirurgie", "Schmerztherapie"],
    availability: "Diese Woche",
    nextSlot: "Mi, 15:45",
    languages: ["Deutsch", "Englisch"],
    photo: drHo.url,
  ...
  },
  {
    ...
    bio: [
      ...
      "Sein Medizinstudium absolvierte er an der Universidad del Zulia in Maracaibo, Venezuela (2005 bis 2011). Anschließend arbeitete er als Landarzt in der Allgemeinmedizin und danach in der postgradualen Facharztausbildung am General Krankenhaus des Südens in Maracaibo, mit komplexen Notfällen, Schädel-Hirn-Traumata und Tumorpatienten.",
      ...
      "Aktuell promoviert er an der Universität zu Lübeck zum Thema „Ultrafrühe Kranioplastik, Eine retrospektive Analyse im Zeitraum 2010 bis 2020 am Nordwest Krankenhaus Sanderbusch“.",
    ...
    education: [
      "Medizinstudium Universidad del Zulia, Maracaibo (2005 bis 2011)",
  ...
  },
  {
    ...
    bio: [
      ...
      "Von 1995 bis 1998 war Dr. Bernhard Lukas als Oberarzt für Hand- und Plastische Chirurgie tätig, zunächst in der Chirurgischen Uniklinik München Nußbaumstraße, danach im Behandlungszentrum Vogtareuth, wo er ab 1998 als Leitender Arzt fungierte.",
