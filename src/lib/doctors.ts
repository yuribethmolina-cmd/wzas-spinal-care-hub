...
export const doctors: Doctor[] = [
  ...
  },
  {
    ...
    bio: [
      "Dr. Marko Ständer gründete 2006 gemeinsam mit Dr. Medele das Wirbelsäulenzentrum am Stiglmaierplatz.",
      "Klinisch und wissenschaftlich beschäftigt er sich mit innovativen Verfahren rund um das Volksleiden Rückenschmerz; zusammen mit Prof. Dr. Steude perfektionierte er die interventionelle Kryotherapie der Facettengelenke.",
    ],
    education: [
