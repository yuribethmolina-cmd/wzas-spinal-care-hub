...
function BeschwerdenHub() {
  ...
  const t = useT({
    ...
    en: {
      ...
      introText: "Back pain, herniated discs and spinal stenosis can significantly affect daily life. At the Spine Center at Stiglmaierplatz, we diagnose and treat a wide range of spinal conditions, using conservative care whenever possible and surgery only when necessary. Our team of 13 specialists in neurosurgery, orthopaedics and pain medicine supports you from your first appointment through recovery.",
      pullQuote: "\"Conservative treatment first. Surgery only when necessary.\"",
      attribution: ", WZAS principle",
      sectionHeading: "Our focus areas",
      ctaCopy: "Learn more",
      bookingHeading: "Ready for your appointment?",
      bookingBody: "No diagnosis yet? We can help you take the first step. Urgent cases are seen without delay.",
      bookingCta: "Book online",
      trustItems: [
        { icon: "stethoscope", label: "In Munich since 2006" },
        { icon: "shield", label: "Conservative care first" },
        { icon: "calendar", label: "Appointments without a referral" },
      ] as { icon: string; label: string }[],
    },
  });
