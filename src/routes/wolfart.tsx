...
function WolfartPage() {
  ...
  const t = useT({
    de: {
      heroEyebrow: "OPERATIONSSTANDORT · MÜNCHEN-GRÄFELFING",
    ...
    en: {
      ...
      heroH1: "WolfartKlinik",
      heroSubtitle: "Specialist care for complex procedures.",
      ...
      bookingHeading: "Would you like to discuss surgical treatment?",
